...
DecorLumberProfitLocale = {
    enUS = {
        ...
        HINT_AHQTY = "How many of the crafted item are listed on the auction house: total pieces. High values mean high competition. Values from other realms show with * when the current realm has no data; details are in the row tooltip. Click to sort.",
        HINT_AH_MINE_QTY = "How many pieces of this item are listed by the account characters. Current realm first; other realms show with * when the current realm has no data. Details are in the row tooltip. Click to sort.",
    ...
    ruRU = {
        ...
        HINT_AHQTY = "Сколько готового предмета выставлено на аукционе: всего штук. Большие значения — высокая конкуренция. Если на текущем сервере данных нет — значение с другого сервера со звёздочкой (*), детали — в тултипе строки. Клик — сортировка.",
        HINT_AH_MINE_QTY = "Сколько штук этого предмета выставлено персонажами аккаунта. Сначала текущий сервер; если данных нет — значение с другого сервера со звёздочкой (*). Детали — в тултипе строки. Клик — сортировка.",
