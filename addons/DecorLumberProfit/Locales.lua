...
DecorLumberProfitLocale = {
    enUS = {
        ...
        PRINT_HELP = "Commands: /dlp — open window, /dlp help — help, /dlp reset — reset cache, /dlp clear — clear table, /dlp scan — add from active window, /dlp rowheight <16-32> — row height, /dlp locale ru|en|auto — language",
    ...
    ruRU = {
        ...
        PRINT_HELP = "Команды: /dlp — открыть окно, /dlp help — справка, /dlp reset — сброс кэша, /dlp clear — очистить таблицу, /dlp scan — добавить из активного окна, /dlp rowheight <16-32> — высота строк, /dlp locale ru|en|auto — язык",
