...
DecorLumberProfitLocale = {
    enUS = {
        ...
        HINT_AHQTY = "How many of the crafted item are listed on the auction house: total pieces. High values mean high competition. Click to sort.",
        HINT_AH_MINE_QTY = "How many pieces of this item are listed by all known characters of this account on the current realm. Click to sort.",
    ...
    ruRU = {
        ...
        HINT_AHQTY = "Сколько готового предмета выставлено на аукционе: всего штук. Большие значения — высокая конкуренция. Клик — сортировка.",
        HINT_AH_MINE_QTY = "Сколько штук этого предмета выставлено всеми известными персонажами аккаунта на текущем сервере. Клик — сортировка.",
