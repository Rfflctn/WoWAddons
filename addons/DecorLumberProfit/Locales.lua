...
DecorLumberProfitLocale = {
    enUS = {
        ...
        TIP_PRICES_SYNC_TITLE = "Sync prices from Auctionator",
        TIP_PRICES_SYNC_L1 = "Reads Auctionator.API.v1 instantly for every reagent and output item — no auction scan, no 100/min limit.",
        TIP_PRICES_SYNC_L2 = "Needs Auctionator with a fresh scan. Items without data fall back to the auction queue.",
        ...
        HINT_AHQTY = "How many of the crafted item are listed on the auction house: total pieces. High values mean high competition. Current realm only; details are in the row tooltip. Click to sort.",
        HINT_AH_MINE_QTY = "How many pieces of this item are listed by the account characters on this realm. Details are in the row tooltip. Click to sort.",
        ...
        TIP_LEARNED_BY = "Learned by: %s",
        TIP_REAGENTS = "Reagents:",
        TIP_AHQTY_LINE = "On AH: %s",
        TIP_AH_MINE_LINE = "Mine on AH: %s",
        TIP_AH_REALMS_TITLE = "Auction data by realm:",
        TIP_AH_REALMS_NOTE = "Mine counts use the latest saved snapshot for each character.",
        TIP_AH_REALM_LINE = "%s: %s | AH: %s | Mine: %s%s",
        TIP_AH_REALM_STALE = " (stale)",
        ...
        ST_PRUNED = "Removed %d recipes with unsellable output (binds on pickup / warbound etc.).",
        ...
        ST_PRICES_AUCTIONATOR_IMPORTED = "Imported %d prices from Auctionator — no scan needed.",
        ST_PRICES_EXT_PART = "From Auctionator: %d; ",
        ...
        PRINT_HELP = "Commands: /dlp — open window, /dlp help — help, /dlp reset — reset cache, /dlp clear — clear table, /dlp scan — add from active window, /dlp rowheight <16-32> — row height, /dlp locale ru|en|auto — language, /dlp source auto|native|auctionator — price source",
        PRINT_MULTIREALM_SET = "Setting saved: %s (no /reload needed).",
        ...
        PRINT_SOURCE_SET = "Price source: %s (saved, no /reload needed).",
        PRINT_SOURCE_USAGE = "Usage: /dlp source auto|native|auctionator",
        ...
        PRINT_CACHE_RESET = "Price cache and own lots reset",
    ...
    ruRU = {
        ...
        TIP_PRICES_SYNC_TITLE = "Синхронизировать цены из Auctionator",
        TIP_PRICES_SYNC_L1 = "Мгновенно читает Auctionator.API.v1 для каждого реагента и предмета — без скана аукциона и лимита 100/мин.",
        TIP_PRICES_SYNC_L2 = "Нужен Auctionator со свежим сканом. Предметы без данных добираются очередью аукциона.",
        ...
        HINT_AHQTY = "Сколько готового предмета выставлено на аукционе: всего штук. Большие значения — высокая конкуренция. Только текущий сервер; детали — в тултипе строки. Клик — сортировка.",
        HINT_AH_MINE_QTY = "Сколько штук этого предмета выставлено персонажами аккаунта на этом сервере. Детали — в тултипе строки. Клик — сортировка.",
        ...
        TIP_LEARNED_BY = "Изучен: %s",
        TIP_REAGENTS = "Реагенты:",
        TIP_AHQTY_LINE = "На АХ: %s",
        TIP_AH_MINE_LINE = "Моих на АХ: %s",
        TIP_AH_REALMS_TITLE = "Данные аукциона по серверам:",
        TIP_AH_REALMS_NOTE = "Количество моих предметов взято из последнего снимка каждого персонажа.",
        TIP_AH_REALM_LINE = "%s: %s | всего: %s | моих: %s%s",
        TIP_AH_REALM_STALE = " (устарело)",
        ...
        ST_PRUNED = "Убрано %d рецептов с непродаваемой продукцией (персональные при получении / привязанные к отряду и т.п.).",
        ...
        ST_PRICES_AUCTIONATOR_IMPORTED = "Импортировано цен из Auctionator: %d — скан не нужен.",
        ST_PRICES_EXT_PART = "Из Auctionator: %d; ",
        ...
        PRINT_HELP = "Команды: /dlp — открыть окно, /dlp help — справка, /dlp reset — сброс кэша, /dlp clear — очистить таблицу, /dlp scan — добавить из активного окна, /dlp rowheight <16-32> — высота строк, /dlp locale ru|en|auto — язык, /dlp source auto|native|auctionator — источник цен",
        PRINT_MULTIREALM_SET = "Настройка сохранена: %s (/reload не нужен).",
        ...
        PRINT_SOURCE_SET = "Источник цен: %s (сохранено, /reload не нужен).",
        PRINT_SOURCE_USAGE = "Использование: /dlp source auto|native|auctionator",
        ...
        PRINT_CACHE_RESET = "Кэш цен и своих лотов сброшен",
