...
10. Цены и количество предметов на АХ сохраняются отдельно по каждому реалму.
11. Тултип готового предмета показывает цену, общую конкуренцию и мои предметы на всех известных реалмах.
...
/dlp multirealm on|off — тултип по всем серверам (по умолчанию off, для масс — один мир)
...
4. Откройте тултип строки — он покажет данные предмета по всем реалмам, где выполнялось сканирование.
