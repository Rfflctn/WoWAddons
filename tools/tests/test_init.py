...
def run(lua, check, exec_):
    ...
    check('addon version', 'DecorLumberProfit.VERSION', '2.5.4')
    ...
    check('diag version tracks init', 'tostring(string.find(DecorLumberProfitDiag.ADDON_VERSION, "2.5.4", 1, true) ~= nil)', 'true')
