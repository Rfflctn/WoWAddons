...
def run(lua, check, exec_):
    ...
    check('addon version', 'DecorLumberProfit.VERSION', '2.3.2')
    ...
    check('diag version tracks init', 'tostring(string.find(DecorLumberProfitDiag.ADDON_VERSION, "2.3.2", 1, true) ~= nil)', 'true')
