...
def run(lua, check, exec_):
    ...
    check('addon version', 'DecorLumberProfit.VERSION', '2.2.0')
    ...
    check('diag version tracks init', 'tostring(string.find(DecorLumberProfitDiag.ADDON_VERSION, "2.2.0", 1, true) ~= nil)', 'true')
